...
class WC_Conekta_Spei_Gateway extends WC_Conekta_Plugin
{
    ...
    public function __construct()
    {
        ...
        for ( $i = 1; $i <= $no_accounts; $i++ ) {
          $new_accounts = array(
            ...
            'title'                => $this->get_option( 'account_' . sprintf("%02d", $i) . '_title' ),
    ...
    public function ckpg_init_form_fields()
    {
        ...
        $this->form_fields = array(
          ...
          'account_01_title' => array(
            'type'        => 'text',
            'title'       => __( '1. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_02_title' => array(
            'type'        => 'text',
            'title'       => __( '2. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_03_title' => array(
            'type'        => 'text',
            'title'       => __( '3. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_04_title' => array(
            'type'        => 'text',
            'title'       => __( '4. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_05_title' => array(
            'type'        => 'text',
            'title'       => __( '5. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_06_title' => array(
            'type'        => 'text',
            'title'       => __( '6. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_07_title' => array(
            'type'        => 'text',
            'title'       => __( '7. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_08_title' => array(
            'type'        => 'text',
            'title'       => __( '8. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_09_title' => array(
            'type'        => 'text',
            'title'       => __( '9. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_10_title' => array(
            'type'        => 'text',
            'title'       => __( '10. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_11_title' => array(
            'type'        => 'text',
            'title'       => __( '11. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_12_title' => array(
            'type'        => 'text',
            'title'       => __( '12. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_13_title' => array(
            'type'        => 'text',
            'title'       => __( '13. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_14_title' => array(
            'type'        => 'text',
            'title'       => __( '14. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_15_title' => array(
            'type'        => 'text',
            'title'       => __( '15. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_16_title' => array(
            'type'        => 'text',
            'title'       => __( '16. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_17_title' => array(
            'type'        => 'text',
            'title'       => __( '17. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_18_title' => array(
            'type'        => 'text',
            'title'       => __( '18. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_19_title' => array(
            'type'        => 'text',
            'title'       => __( '19. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_20_title' => array(
            'type'        => 'text',
            'title'       => __( '20. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_21_title' => array(
            'type'        => 'text',
            'title'       => __( '21. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_22_title' => array(
            'type'        => 'text',
            'title'       => __( '22. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_23_title' => array(
            'type'        => 'text',
            'title'       => __( '23. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_24_title' => array(
            'type'        => 'text',
            'title'       => __( '24. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
          ...
          'account_25_title' => array(
            'type'        => 'text',
            'title'       => __( '25. Títular de la cuenta', 'wc-conekta-gw' ),
            'description' => __( 'This controls the title which the user sees during checkout.', 'wc-conekta-gw' ),
            'default'     => __( '', 'wc-conekta-gw' ),
          ),
